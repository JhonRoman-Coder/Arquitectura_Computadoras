...
<%
    request.setAttribute("numeroUnidad", "4");
%>
...
<head>
    ...
    <title>Unidad IV | Mi Portafolio</title>
...
<aside class="sidebar">
    ...
    <nav class="menu">
        ...
        <a href="unidad4.jsp" class="active">📕 Unidad IV</a>
    </nav>
...
<main class="main-content">
    ...
    <section class="welcome-section">
        ...
        <span class="section-label">CUARTA UNIDAD</span>

        <h2>Contenido de la Unidad IV</h2>

        <p>
            Administra tus trabajos, documentos y actividades
    ...
    <section class="weeks-section">
        ...
        <%
            for (int semana = 13; semana <= 16; semana++) {
