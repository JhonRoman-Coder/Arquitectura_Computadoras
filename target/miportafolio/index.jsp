    ...
    <div class="app-container">
        ...
        <main class="main-content">
            ...
            <header class="topbar">
                ...
                <div>
                    <p class="topbar-subtitle">PORTAFOLIO ACADÉMICO</p>
            ...
            <section class="welcome-section">
                ...
                <div class="welcome-content">
                    ...
                    <span class="tag">BIENVENIDO A MI PORTAFOLIO</span>
                    ...
                    <p>
                        Este espacio reúne mis actividades, materiales,
                        conocimientos y evidencias académicas del curso
            ...
            <section class="content-section" id="unidades">
                ...
                <div class="section-heading">
                    <div>
                        <span class="section-label">CONTENIDO DEL CURSO</span>
                        <h2>Unidades académicas</h2>
                    </div>

                    <span class="section-counter">04 unidades</span>
                </div>

                <div class="units-grid">

                    <a href="unidades/unidad1.jsp" class="unit-card">
                    ...
                    <a href="unidades/unidad2.jsp" class="unit-card">
                    ...
                    <a href="unidades/unidad3.jsp" class="unit-card">
                    ...
                    <a href="unidades/unidad4.jsp" class="unit-card">
