...
<main>
    ...
    <p>
        Frameworks y Estándares para la Implementación de Arquitecturas
    </p>
    ...
    for (int semana = 1; semana <= 4; semana++) {
        ...
        String ruta = application.getRealPath(
            "/assets/documentos/unidad4/" + nombreSemana
        );
    ...
    <section>
        ...
        <div>
            ...
            <a
                href="../assets/documentos/unidad4/<%= nombreSemana %>/<%= nombreCodificado %>"
                target="_blank">
                Ver archivo
            </a>
